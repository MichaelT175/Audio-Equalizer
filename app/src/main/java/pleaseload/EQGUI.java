...
/**
 * EQGUI is a graphical user interface for an audio equalizer application with visualizer support.
 * It allows users to adjust bass, mid, and treble levels, play audio files with equalizer settings,
 * manage song presets, view visual audio representations, and more.
 */
public class EQGUI {
    ...
    /**
     * Creates and displays the main graphical user interface.
     */
    ...
    /**
     * Sets up the main window frame for the application.
     *
     * @return The JFrame object for the application window.
     */
    ...
    /**
     * Sets up the main panel which will contain all the other components.
     *
     * @return The JPanel for the main content area.
     */
    ...
    /**
     * Sets up the center panel containing the visualizer and spectrum display. 
     *
     * @return The JPanel for the center content area (visualizer and spectrum panels).
     */
    ...
    /**
     * Sets up the sliders panel for bass, mid, and treble adjustments.
     *
     * @return The JPanel containing the sliders for audio adjustments.
     */
    ...
    /**
     * Sets up the bottom panel containing the song selection dropdown and control buttons.
     *
     * @param centerPanel The center panel containing the visualizer and spectrum panels.
     * @return The JPanel for the bottom content area with control buttons.
     */
    private static JPanel setupBottomPanel(JPanel centerPanel) {
        ...
        // Create action buttons and set up listeners
        ...
        playButton.addActionListener(e -> playSelectedSong(songMenu, centerPanel));
        ...
        savePresetButton.addActionListener(e -> savePreset(songMenu));
        loadPresetButton.addActionListener(e -> loadPreset(songMenu));
    ...
    /**
     * Creates a styled button with a specific background and foreground color.
     *
     * @param text The text to display on the button.
     * @return A JButton with the styled appearance.
     */
     ...
     * @return A JPanel containing the label and the slider.
     */
    ...
    /**
     * Starts playing the selected song with the current equalizer settings.
     *
     * @param songMenu The SongMenu object used to get the selected song path.
     * @param centerPanel The center panel containing the visualizer and spectrum panels.
     */
    private static void playSelectedSong(SongMenu songMenu, JPanel centerPanel) {
    ...
    /**
     * Saves the current equalizer settings as a preset for the selected song.
     *
     * @param songMenu The SongMenu object used to get the selected song.
     */
    private static void savePreset(SongMenu songMenu) {
    ...
    /**
     * Loads a preset for the selected song from the available presets.
     *
     * @param songMenu The SongMenu object used to get the selected song.
     */
    private static void loadPreset(SongMenu songMenu) {
        String selectedSong = (String) songDropdown.getSelectedItem();
        if (selectedSong != null) {
    ...
    /**
     * Retrieves the current value of the bass slider.
     * 
     * @return The current bass gain value (in decibels) based on the position of the bass slider.
     * The value is updated when the slider is changed.
     */
    ...
    /**
     * Retrieves the current value of the mid slider.
     * 
     * @return The current mid gain value (in decibels) based on the position of the mid slider.
     * The value is updated when the slider is changed.
     */
    ...
    /**
     * Retrieves the current value of the treble slider.
     * 
     * @return The current treble gain value (in decibels) based on the position of the treble slider.
     * The value is updated when the slider is changed.
     */
    ...
    /**
     * Opens a dialog window to display the contents of the README file.
     */
    private static void openReadmeInPopup() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Michael Jr\\Desktop\\Audio-Equalizer\\README.md"))) {
            String line;
